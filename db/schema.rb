...
ActiveRecord::Schema[7.0].define(version: 2024_10_25_152837) do
  ...
  create_table "scheduled_tasks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "switch_value", default: false, null: false
    t.integer "vacan", default: 1, null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer "avcpoints", default: 5
    t.integer "health", default: 240
    t.datetime "online_field"
    t.integer "telegramid"
    t.string "telegramusername"
  end
